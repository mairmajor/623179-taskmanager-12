...
const cardRender = (count, container, template, place) => {
    render(container, template, place);
    let siteBoardTasksElement = siteMainElement.querySelector(`.board__tasks`);
    for (var i = 0; i < count; i++) {
        render(siteBoardTasksElement, createTaskCardTemplate(), `beforeend`);
    }
};
...
cardRender(3, siteMainElement, createBoardTasksTemplate(), `beforeend`);
render(siteMainElement, createLoadButtonTemplate(), `beforeend`);
